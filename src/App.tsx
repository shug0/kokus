  ...
  return (
    ...
    >
      <header className="mb-auto">
        <h1 className="text-7xl font-light mb-4">Kokus</h1>
      ...
      <section className="flex flex-col items-center">
        ...
        <div className="mb-8 flex flex-col gap-2">
          <div className="text-4xl font-semibold">{randomJob}</div>
          <div>ascendant..</div>
          <div className="text-4xl font-semibold">{randomAnimal}</div>
          <div>avec..</div>
          <div className="text-4xl font-semibold">{randomEmotion}</div>
        </div>
      </section>
      <button
